/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9a7f812505b665cff84ea7a99a921830)
...
interface __BaseEnv_Env {
	...
	USER_MEDIA_QUOTA_BYTES: "209715200";
	...
	ENFORCE_STORAGE_QUOTAS: string;
	CORS_ORIGINS: string;
	WS_HUB: DurableObjectNamespace<import("./src/index").WsHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WsHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_TOKEN_TTL_SEC" | "REFRESH_TOKEN_TTL_SEC" | "USER_MEDIA_QUOTA_BYTES" | "MAX_UPLOADS_PER_DAY" | "JWT_SECRET" | "ADMIN_USERNAMES" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "KLIPY_API_KEY" | "ENFORCE_STORAGE_QUOTAS">> {}
}
